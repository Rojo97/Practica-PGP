const db = {
    ...
    querys: {
        ...
        actividades : {
            ...
            getActividadIntervalo : 'SELECT Inf.nickUsuario, A.nombreActividad FROM InformeSemanal Inf, Actividad A WHERE A.nombreActividad = Inf.nombreActividad AND A.nombreProyecto = Infr.nombreProyecto AND A.nombreProyecto = ? AND A.fechaInicio >= ? AND A.fechaInicio < ?',
