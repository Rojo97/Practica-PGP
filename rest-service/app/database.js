const db = {
    ...
    querys: {
        ...
        actividades : {
            ...
            getActividadCritica : 'SELECT A.nombreActividad FROM Actividad A, (SELECT Inf.nombreActividad, SUM(Inf.horas) AS horasTotales FROM InformeSemanal Inf,Actividad A WHERE A.nombreActividad = Inf.nombreActividad AND A.nombreProyecto = Inf.nombreProyecto) Horas WHERE A.nombreProyecto = ? AND A.duracionEstimada < Horas.horasTotales',
