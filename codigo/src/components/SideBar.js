          ...
          <ul className="sidebar-menu" data-widget="tree">
            ...
            <li className="active treeview">
              ...
              <ul className="treeview-menu">
                ...
                <li className="active"><Link to="/developer/activity/A"><i className="fa fa-circle-o"></i>Actividad</Link></li>
              </ul>
            </li>
            <li className="active treeview">
              <a href="#">
              ...
              <ul className="treeview-menu">
                ...
                <li className="active"><Link to="/projectManager/activity/A"><i className="fa fa-circle-o"></i>Ver y editar actividad</Link></li>
              </ul>
            </li>
